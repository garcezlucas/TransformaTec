var pessoa = '{"nome": "Lucas","idade" : 27}'

var idade = pessoa.idade

console.log("Tipo do dado:", typeof(pessoa))
console.log("Propriedade do objeto string:", pessoa.nome)

var pessoa_obj = JSON.parse(pessoa)

console.log("Tipo do dado:", typeof(pessoa_obj))
